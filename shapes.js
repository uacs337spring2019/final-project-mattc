...
(function() {
	...
	function saveCreation(){
		...
		if(space == ""){ // If the space is empty
			...
			let url = "http://shapes1.herokuapp.com:process.env.port"; // Call the host for the post
	...
	function getRandomCreation(){
		...
		document.getElementById("message").style.visibility = "hidden"; 
		let url = "http://shapes1.herokuapp.com:process.env.port"; // Calls the server for info 
		fetch(url) 
